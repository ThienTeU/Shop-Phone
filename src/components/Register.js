                        ...
                        <div className="mb-3">
                            ...
                            <div>
                                ...
                                <div style={{paddingTop:"10px"}}>
                                    ...
                                    <label htmlFor="receive-promotions" className="ml-2">Đăng ký nhận bản tin khuyến mãi từ H-Tech Store</label>
                                </div>
                                <div style={{paddingTop:"10px", paddingBottom:"20px"}}>
                                    <input type="checkbox" id="agree-privacy-policy" />
                                    <label htmlFor="agree-privacy-policy" className="ml-2">Tôi đồng ý với các điều khoản bảo mật cá nhân</label>
                                </div>
                            </div>
                        </div>
                        <div className='text-center'>
                            <button type="submit" className="btn btn-dark btn-lg">Đăng Ký</button>
                        </div>
                        <div className="mt-3 text-center">
                            <p>Bạn Đã Có Tài Khoản Rồi? {" "}
