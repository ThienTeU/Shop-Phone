...
const AnswerQuestion = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!topic || !title || !content || !fullName || !email || !phone) {
      alert(
        "Vui lòng nhập đầy đủ các thông tin để chúng tôi có thể hiểu rõ nhất vấn đề bạn đang gặp !"
      );
      return;
    }
  };
  ...
  return (
    <Row>
      <div
        style={{ marginLeft: "72px", marginBottom: "20px", marginTop: "8px" }}
      >
        <a
          href="/productuser"
      ...
      <Col md={6}>
        <p className="title-welcome">
          H-TECH STORE XIN HÂN HẠNH ĐƯỢC HỖ TRỢ BẠN
        </p>
        ...
        <Row style={{ marginRight: "50px", marginTop: "20px" }}>
          ...
          <p>
            ...
            <span style={{ color: "blue", fontWeight: "bold" }}>
              ccoolls147@gmail.com || (Nguyễn Đức Huy)
            </span>
          </p>
          <p>
            Tổng đài tư vấn, hỗ trợ khách hàng (7:30 - 23:00):{" "}
            <span style={{ color: "#f60", fontWeight: "bold" }}>
              0902 345 678
            </span>
          </p>
          <p>
            Tổng đài khiếu nại (8:00 - 22:30):{" "}
            <span style={{ color: "#f60", fontWeight: "bold" }}>1900.3103</span>
          </p>
          <p>
            Email:{" "}
            <span style={{ color: "blue", fontWeight: "bold" }}>
          ...
          <Row className="end-answerquestion">
            <Col md={4}>
              <p className="title2-end-answerquestion">
                CỬA HÀNG THIẾT BỊ ĐIỆN TỬ H-TECH STORE
              </p>
              <hr></hr>
